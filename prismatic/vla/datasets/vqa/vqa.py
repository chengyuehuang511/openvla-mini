...
Then, run conversion locally (make sure to install tensorflow-datasets for the `tfds` util):
  ...
  env TFDS_DATA_DIR=/coc/testnvme/chuang475/datasets/tensorflow_datasets tfds build --datasets=vqa
...
_VQAV2_PATH = '/srv/datasets/vqa2.0'
_IMAGE_PATH = '/coc/pskynet6/chuang475/.cache/lavis/coco/images'
