...
`tfds` util):
  ...
  env TFDS_DATA_DIR=/coc/testnvme/chuang475/datasets/tensorflow_datasets tfds build --datasets=okvqa

Example to load:

  import tensorflow_datasets as tfds
  dataset = tfds.load('okvqa', split='val', data_dir='/coc/testnvme/chuang475/datasets/tensorflow_datasets')
"""
...
_OKVQA_PATH = '/coc/testnvme/chuang475/projects/openvla-mini/data/okvqa'
